        ...
        <div className={contactStyle.alertSuccess}>
          <Alert>
            <button
              ...
              aria-label="croix de fermeture de la bannière confirmant l'envoi du message"
            >
              <ExitCross alt="croix de fermeture de la bannière confirmant l'envoi du message" />
            </button>
